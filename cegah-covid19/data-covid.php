...
<html lang="en">
  <head>
    ...
    <title>Cegah Covid-19 | Data Covid-19</title>
  </head>
  <body>
        ...
        <div class="container container-body">
            ...
            <div class="bg-corona">
                ...
                <section class="data-covid">
                    <h1 class="title">Data Penyebaran dan Vaksinasi Covid 19</h1>
                    <br>
                    <br>
                    <!-- <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg">
                            <div class="card">
                                <h5 class="card-title">Total Sudah Divaksin</h5>
                                <H1><?= number_format($total_vaksin);?></H1>
                                <p class="card-text">ORANG</p>
                            </div>
                        </div>
                    </div>
